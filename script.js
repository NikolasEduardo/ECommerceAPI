...
/* <div class="col-lg-4  col-md-6  col-sm-12">
    <div class="d-flex justify-content-center">
        <div class="card" style="width: 20rem;">
            <div id="carousel${x}" class="carousel slide">
                <div class="carousel-indicators"><button type="button" data-bs-target="#carousel${x}"
                        data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button><button
                        type="button" data-bs-target="#carousel${x}" data-bs-slide-to="1"
                        aria-label="Slide 2"></button><button type="button" data-bs-target="#carousel${x}"
                        data-bs-slide-to="2" aria-label="Slide 3"></button><button type="button"
                        data-bs-target="#carousel${x}" data-bs-slide-to="3" aria-label="Slide 4"></button></div>
                <div class="carousel-inner">
                    <div class="carousel-item active"><img src="imagem/teste1.jpg" height="200px" id="imagem1do${x}">
                    </div>
                    <div class="carousel-item"><img src="imagem/teste2.jpg" height="200px" id="imagem2do${x}"></div>
                    <div class="carousel-item"><img src="imagem/teste3.jpg" height="200px" id="imagem3do${x}"></div>
                    <div class="carousel-item"><img src="imagem/teste4.jpg" height="200px" id="imagem4do${x}"></div>
                </div><button class="carousel-control-prev" type="button" data-bs-target="#carousel${x}"
                    data-bs-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span
                        class="visually-hidden">Previous</span></button><button class="carousel-control-next"
                    type="button" data-bs-target="#carousel${x}" data-bs-slide="next"><span
                        class="carousel-control-next-icon" aria-hidden="true"></span><span
                        class="visually-hidden">Next</span></button>
            </div>
            <div class="card-body">
                <h5 id="nome${x}" class="card-title ">Card title</h5>
                <p id="descricao${x}" class="card-text">Some quick example text to build on the card titleand make up
                    the bulk of the card's content.</p><a href="produto.html#${x}" class="btn btn-light ">Comprar</a>
            </div>
        </div>
    </div>
</div> */
